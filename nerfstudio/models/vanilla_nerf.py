...
@dataclass
class VanillaNeRFClassicModelConfig(ModelConfig):
    """Vanilla NeRF Classic Model Config (stratified sampling with coarse/fine networks)"""

    _target: Type = field(default_factory=lambda: NeRFClassicModel)
...
class NeRFClassicModel(Model):
    """Vanilla NeRF Classic model (original paper implementation with stratified sampling)

    Args:
        config: Basic NeRF configuration to instantiate model
    """

    config: VanillaNeRFClassicModelConfig
